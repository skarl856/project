...
<div id="wrap">
    ...
    <div id="container">
        ...
        <div style="width: 687px; margin: 0 auto;">
            ...
            <button type="button" class="btn-outline-secondary btn-sm" onclick="" style="float: right; width: 70px;">검색</button>
        </div>
        ...
        <div style="text-align: right;">
            <button type="button" class="btn-outline-secondary btn-sm" 
            		onclick="location.href='${rootPath}/admin/admin_web_improve_write.do'" 
