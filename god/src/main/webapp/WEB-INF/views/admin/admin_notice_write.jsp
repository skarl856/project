...
<div id="wrap">
    ...
    <div id="container">
        ...
        <div>
            ...
            <!-- 제목 입력 박스 -->
            <input type="text" id="input_text" placeholder="제목을 입력하세요!" style="font-size: 11pt;">
        ...
        <div style="margin: 30px 0; text-align: center;">
            <button type="button" class="btn btn-outline-secondary btn-sm" style="width: 80px; margin-right: 10px;">작성 완료</button>
            <button type="button" class="btn btn-outline-secondary btn-sm" style="width: 80px; margin-left: 10px;">작성 취소</button>
        </div>
